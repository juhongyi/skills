...
7. Interview the user before writing project documentation. Ask focused questions about the product goals, users, scope, requirements, constraints, architecture, key decisions, and design. Resolve unclear or missing details with follow-up questions instead of making assumptions.
8. Create the following files under `<project-root>/docs/` from the interview answers and initialized project. Keep each file at or below 300 lines:
   ...
   - `DESIGN.md`: user experience, interfaces, data models, and important interaction details.
